...
1. exercícios 18-26 com procedimentos (Sem retorno) em Python SEM
...
2. exercícios do 27 ao 29 com procedimentos em Python COM PASSAGEM DE
...
20. Receba 3 coeficientes A, B, e C de uma equação do 2º grau da fórmula AX²+BX+C=0. Verifique
...
23. Receba 3 valores obrigatoriamente em ordem crescente e um 4º valor não necessariamente
